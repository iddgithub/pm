...
import RimagOrderDetailReplica from '../features/doctor-ordering/pages/RimagOrderDetailReplica'
...
export const h5Routes = [
  ...
  { path: '/doctor-ordering/rimag-order-detail', label: '一脉阳光订单详情复刻', component: RimagOrderDetailReplica },
