...
- `01_agents/`：沉淀可复用的 PM 角色定义，给 Codex 提供稳定的执行身份
...
- `.claude/commands/`：给 Codex 使用的命令说明和方法入口
...
5. 每次新增、移动或归档文档后，同步更新相关目录的 `AGENTS.md` 与相关 `README.md`。
